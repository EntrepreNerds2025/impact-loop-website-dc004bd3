...
const projects = [
  {
    ...
    description: "EmployNext partnered with construction organizations, employers, and training centres to address youth unemployment and the growing skilled trades shortage across Ontario. Participants gained hands-on experience, industry certifications, and the soft skills employers demand — dependability, reliability, and professionalism. We produced a documentary-style piece capturing real voices from participants, instructors, and employers to demonstrate the program's impact and inspire the next cohort.",
    vimeoId: "1174716942",
  },
  {
    id: 14,
